...
use super::sea_orm_active_enums::LevelLength;
...
pub enum Relation {
	#[sea_orm(has_one = "super::moderator::Entity")]
	Moderator,
...
impl Related<super::reviewer::Entity> for Entity {
	fn to() -> RelationDef {
		super::review::Relation::Reviewer.def()
	}
	fn via() -> Option<RelationDef> {
		Some(super::review::Relation::LevelRequest.def().rev())
	}
}
